...
class LocalPushNotifications {
  ...
  static Future showPeriodicNotifications({
    ...
    await _flutterLocalNotificationsPlugin.periodicallyShow(
        ...
        payload: payload, androidScheduleMode: AndroidScheduleMode.exact); //반복 간격 지정. 매 분마다 반복
  }
  ...
  // 1시간마다 알림 스케줄링
  static Future<void> scheduleHourlyNotification() async {
    for (int i = 1; i <= 9; i++) { // 최대 8시간까지 스케줄링
      await _flutterLocalNotificationsPlugin.zonedSchedule(
        i,
        '근무 시간 알림',
        '근무 시간이 $i 시간이 되었습니다.',
